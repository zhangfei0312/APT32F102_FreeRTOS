...
{
	RTC->KEY=0XCA53;
	if((RTC_TimeDate->u8Hour)==0x12)
		RTC->TIMR=(RTC_TimeDate->u8Hour<<16)|(RTC_TimeDate->u8Minute<<8)|(RTC_TimeDate->u8Second)|(1<<22);
	else 
		RTC->TIMR=(RTC_TimeDate->u8Hour<<16)|(RTC_TimeDate->u8Minute<<8)|(RTC_TimeDate->u8Second);
